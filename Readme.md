...
We tried to submit to the Amazon App Store but gave up because the standard Android operating system requires location permission to make bluetooth discovery work, but Fire tablets don't have GPS location, so requiring this permission makes the app technically invalid per Amazon's approval criterian.     
